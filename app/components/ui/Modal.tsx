...
export function Modal({
  ...
  // Guardamos a última referência para que o efeito de foco/Escape NÃO precise
  ...
  // Escape para fechar + foco inicial + restore. Deps: só `open` — ver nota
  // em `onCloseRef` acima.
  useEffect(() => {
    if (!open) return
    ...
    if (dialog) {
      // Respeita um campo marcado com `autoFocus` (ex.: o valor no modal de
      // baixa); só então cai para o primeiro focável.
      const target =
